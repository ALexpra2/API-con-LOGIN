...
router.get('/search', verifyToken, (req, res) => {
    ...
    if (user) {
        //Aqui he cambiado /allcharacters para crear una ruta independiente que no se llame character y /character/.name pos solo /character poque el :name non lo acepta html en el envio
        res.send(`
